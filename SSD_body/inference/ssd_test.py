...
class SSD(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.generate()
        self.bbox_util = BBoxUtility(self.num_classes, overlap_threshold=0.5, nms_thresh=self.nms_thresh) # (self, num_classes, priors=None, overlap_threshold=0.5, nms_thresh=0.3, top_k=400)
    #---------------------------------------------------#
    #   获得所有的分类
    #---------------------------------------------------#
    def _get_class(self):
