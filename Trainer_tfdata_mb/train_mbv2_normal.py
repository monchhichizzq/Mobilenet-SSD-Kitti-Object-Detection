...
from Models.Mobilenetv2_SSD import mobilenetv2_ssd
from tensorflow.keras.optimizers import Adam

from Preprocess.TFData_Loader import build_input

from Loss.Loss_Sparsity import MultiboxLoss
from Preprocess.anchors import get_pruned_mobilenetv2_anchors, get_mobilenetv2_anchors
...
config = {'Training mode': True,
          ...
          # checkpoint
          'checkpoint_dir':'logs_v1/train_mbv2',
          ...
          # Path
          'anchor_path': '../Pretrained_models/original/full_160_480_anchors.pkl',
...
if __name__ == "__main__":
    ...
    priors = get_pruned_mobilenetv2_anchors(img_size=(w, h))
    ...
    SSDBN_model = mobilenetv2_ssd(input_shape=(160, 480, 3),
                                 is_relu6=True,
                                 num_classes=config['num_classes'],
