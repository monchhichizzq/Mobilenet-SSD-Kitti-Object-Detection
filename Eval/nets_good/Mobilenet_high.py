...
def mobilenet(input_tensor):
    ...
    # Block 9
    # 2,4,256 -> 1,2,128
    net['conv9_0'] = conv2d_bn(7, net['conv8_2'], 64, 1, 1)
    net['conv9_1'] = conv2d_bn(8, net['conv9_0'], 128, 3, 3, stride=2)
    net['conv9_2'] = conv2d_bn(9, net['conv9_1'], 128, 3, 3, stride=2) # 1,2,128 -> 1,1,128
    # ----------------------------主干特征提取网络结束---------------------------#
    return net
